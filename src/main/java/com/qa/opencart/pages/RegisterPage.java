...
public class RegisterPage {
	...
	private By loggoutLink=By.linkText("Logout");
	...
	eleUtil.doSendKeysWithVisibleElement(this.firstName, AppConstants.DEFAULT_LARGE_TIME_OUT, firstName);	
		...
		String succMsg=eleUtil.waitForElementVisible(registerSuccessMsg, AppConstants.DEFAULT_LARGE_TIME_OUT).getText();
		System.out.println("sucess msggg======>:" +succMsg);
		 
		eleUtil.doClick(loggoutLink);
